...
// Different types of data handling for hhe sensors
...
NodeSequence.prototype.validateDeviceProperties = function(data) 
{
...
DeviceGyroInputDistanceSensor.prototype.createDefaultDevice = function()
{
	var data = {
		...
		config: { position: GYRO_MOTOR_POSITION_LEFT, data_mode:GYRO_DISTANCE_SENSOR_DATA_MODE_ANALOG, threshold:GYRO_DISTANCE_SENSOR_DEFAULT_THRESHOLD }
	}
